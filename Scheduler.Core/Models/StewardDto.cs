...
namespace Scheduler.Core.Models
{
    public class StewardDto
    {
        ...
        /// <summary>
        /// checks if the steward is available at the given time considering rest requirements (needed if the project has more than 2 weeks)
        /// </summary>
        ...
        public bool IsAvailableForFlight(FlightDto flight, WeeklySchedule schedule)
        {
            ...
            // check or conflicts with existing flights (like overlapping or rest time)
        ...
        {
            //cCheck for overlap or insufficient rest with ALL existing flights
        ...
        public static bool HasEnoughRestBetween(FlightDto flight1, FlightDto flight2)
        {
            ...
            // check if there's at least 12 hours between the end of the earlier flight and the start of the later flight
            TimeSpan restTime = laterFlight.DepartureTime - earlierFlight.ArrivalTime;
            return restTime.TotalHours >= 12;
        }
        ///<summary>
        /// dhecks whether steward speaks this language or no
        /// </summary>
